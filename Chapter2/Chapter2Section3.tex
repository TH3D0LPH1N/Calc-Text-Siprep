...
\begin{tcolorbox}[solution]
    ...
    a) \begin{align*}
        ...
        (\dd x)\dfrac{y \,\mathrm{d}y}{\dd x} &= -x(\dd x) \\[11pt]
        \Aboxed{y \,\mathrm{d}y &= -x \,\mathrm{d}x}
    \end{align*}
    b) \begin{align*}
        \left(\dfrac{1}{\sec (y)}\right)\deriv &= x\sec (y)\left(\dfrac{1}{\sec (y)}\right) \\[11pt]
        (\dd x)\cos (y)\deriv &= x(\dd x) \\[11pt]
        \Aboxed{\cos (y) \,\mathrm{d}y &= x \,\mathrm{d}x}
    \end{align*}
    c) \begin{align*}
        \deriv &= (2x - 3)y \\[11pt]
        \left(\dfrac{1}{y}\right)\deriv &= (2x - 3)y\left(\dfrac{1}{y}\right) \\[11pt]
        (\dd x)\left(\dfrac{1}{y}\right)\deriv &= (2x - 3)(\dd x) \\[11pt]
        \Aboxed{\dfrac{1}{y} \,\mathrm{d}y &= (2x - 3) \,\mathrm{d}x}
    \end{align*}
...
\begin{enumerate}
    \item Separate the variables. Move all terms involving $y$ (and $\dd y$) to one side and all terms involving $x$ (and $\dd x$) to the other. Keep any constants on the right side of the equation.
...
\begin{tcolorbox}[solution]
    \textbf{Sol 2.3.2: } \vspace{11pt} \begin{alignat*}{2}
        ...
        & y \,\mathrm{d}y = -x \,\mathrm{d}x &\qquad& \text{Separate all the $y$ terms to the left side of the equation} \\
        &  &\qquad& \text{and all of the $x$ terms to the right side.} \\[11pt]
        & \int y \,\mathrm{d}y = \int -x \,\mathrm{d}x &\qquad& \text{Integrate both sides.} \\[11pt]
...
\begin{tcolorbox}[example]
    \textbf{Ex 2.3.3: } Find the general solution to the differential equation $\dfrac{\dd m}{\dd t} = mt$
\end{tcolorbox}
\begin{tcolorbox}[solution]
    \textbf{Sol 2.3.2: } \vspace{11pt} \begin{alignat*}{2}
        & \dfrac{\dd m}{\dd t} = mt &\qquad& \text{Start here.} \\[11pt]
        & \dfrac{1}{m} \,\mathrm{d}m = t \,\mathrm{d}t &\qquad& \text{Separate all the $m$ terms to the left side of the equation} \\
        & &\qquad& \text{and all of the $t$ terms to the right side of the equation.} \\[11pt]
        & \int \dfrac{1}{m} \,\mathrm{d}m = \int t \,\mathrm{d}t &\qquad& \text{Integrate both sides.} \\[11pt]
...
\begin{tcolorbox}[solution]
    \textbf{Sol 2.3.4: } To find the particular solution, recall that we first need to find the general solution. \begin{align*}
        \deriv &= (2x - 3)y \\[11pt]
        \int \dfrac{1}{y} \,\mathrm{d}y &= \int (2x - 3) \,\mathrm{d}x \\[11pt]
        \ln |y| &= x^2 - 3x + C \\[11pt]
        y &\begin{aligned}[t]
            & = e^{x^2 - 3x + C} \\[11pt]
            & = e^{x^2 - 3x}e^C \\[11pt]
...
\begin{tcolorbox}[solution]
    \textbf{Sol 2.3.5: } Once again, let's find the general solution first. \begin{align*}
        \deriv &= x^2y \\[11pt]
        \int \dfrac{1}{y} &= \int x^2 \,\mathrm{d}x \\[11pt]
...
\begin{tcolorbox}[solution]
    \textbf{Sol 2.3.6: } \begin{align*}
        \deriv &= x^2y^3 \\[11pt]
        \int \dfrac{1}{y^3} \,\mathrm{d}y &= \int x^2 \,\mathrm{d}x \\[11pt]
...
\begin{tcolorbox}[solution]
    ...
    c) \begin{align*}
        ...
        \int \dfrac{1}{y + 1} \,\mathrm{d}y &= \int \dfrac{1}{x^2 + 9} \,\mathrm{d}x \\[11pt]
...
\twoquestion{3. $\left(x^2 + 1\right)\deriv = xy$}{4. $\dfrac{\dd y}{\dd t} = \dfrac{\sec^2 (t)}{\sec (y)\tan (y)}$} \\[11pt]
\twoquestion{5. $\dfrac{\dd v}{\dd t} = 2 + 2v + t + tv$}{6. $\deriv = \dfrac{x^2 + 1}{\sec (y)\tan (y)}$} \\[11pt]
\twoquestion{7. $\dfrac{\dd y}{\dd t} = \dfrac{t}{y\sqrt{y^2 + 1}}$}{8. $\deriv = \dfrac{y^2 + 1}{xy}$} \\[11pt]
...
\twoquestion{13. $\deriv = 4xy^3 \bargap y(0) = -2$}{14. $\dfrac{\dd \theta}{\dd r} = \dfrac{1 + \sqrt{r}}{\sqrt{\theta}} \bargap \theta(4) = 9$} \\[11pt]
...
\twoquestion{25. $\dfrac{\dd u}{\dd t} = \dfrac{2t + \sec^2 (t)}{2u} \bargap u(0) = -5$}{26. $\deriv \left(x^2 + 1\right)(2 - y) \bargap y(1) = 3$} \\[11pt]
...
\begin{questions}
    ...
    \question Identify the first mistake (if any) in this process: \begin{align*}
        ...
        & \text{Step 1:} && \dfrac{1}{y + 1} \,\mathrm{d}y = x \,\mathrm{d}x \\[5.5pt]
    ...
    \question Identify the first mistake (if any) in this process: \begin{align*}
        ...
        & \text{Step 1:} && \dfrac{1}{y^2} \,\mathrm{d}y = 6x^2 \,\mathrm{d}x \\[5.5pt]
