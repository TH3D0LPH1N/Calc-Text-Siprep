...
\begin{enumerate}
    ...
    \item Differentiate $u$ to find $\dd u$ in terms of $\dd x$.
    \item Adjust the integral by multiplying and dividing by a constant if needed so a factor matches $\dd u$. [See \textbf{Ex 2.2.2}]
    \item Rewrite the integral entirely in terms of $u$ and $\dd u$.
...
\begin{tcolorbox}[example]
    \textbf{Ex 2.2.1: } $\int 3x^2\left(x^3 + 5\right)^{10} \,\mathrm{d}x$
\end{tcolorbox}
\begin{tcolorbox}[solution]
    \textbf{Sol 2.2.1: } \begin{align*}
        & \left(x^3 + 5\right) \text{ is the inner function.} \\[11pt]
        & \curvedarrow u = x^3 + 5 \\[5.5pt]
        & \curvedarrow \dd u = 3x^2 \,\mathrm{d}x \\[11pt]
        & \int 3x^2\left(x^3 + 5\right)^{10} \,\mathrm{d}x \begin{aligned}[t]
            & = \int u^{10} \,\mathrm{d}u \\[11pt]
...
\begin{tcolorbox}[example]
    \textbf{Ex 2.2.2: } $\int x\left(x^2 + 5\right)^3 \,\mathrm{d}x$
\end{tcolorbox}
\begin{tcolorbox}[solution]
    \textbf{Sol 2.2.2: } \begin{align*}
        & \left(x^2 + 5\right) \text{ is the inner function.} \\[11pt]
        & \curvedarrow u = x^2 + 5 \\[5.5pt]
        & \curvedarrow \dd u = 2x \,\mathrm{d}x \\[11pt]
        & \int x\left(x^2 + 5\right)^3 \,\mathrm{d}x \begin{aligned}[t]
            & = \dfrac{1}{2}\int (2x)\left(x^2 + 5\right)^3 \,\mathrm{d}x \\[11pt]
            & = \dfrac{1}{2}\int u^3 \,\mathrm{d}u \\[11pt]
            & = \dfrac{1}{2} \cdot \dfrac{u^4}{4} + C \\[11pt]
            & = \boxed{\dfrac{1}{8}\left(x^2 + 5\right)^4 + C}
        \end{aligned}
    \end{align*}
    Notice how the factor of $2$ from $\dd u = 2x\,\mathrm{d}x$ is accounted for by multiplying by $\frac{1}{2}$ when substituting. This ensures the integral is correctly expressed in terms of $u$.
\end{tcolorbox} \vspace{11pt}

\begin{tcolorbox}[example]
    \textbf{Ex 2.2.3: } $\int \left(x^3 + x\right)\sqrt[4]{x^4 + 2x^2 - 5} \,\mathrm{d}x$
\end{tcolorbox}
\begin{tcolorbox}[solution]
    \textbf{Sol 2.2.3: } \begin{align*}
        & \sqrt[4]{x^4 + 2x^2 - 5} \text{ is the inner function.} \\[11pt]
        & \curvedarrow u = x^4 + 2x^2 - 5 \\[5.5pt]
        & \curvedarrow \dd u = \left(4x^3 + 4x\right)\,\mathrm{d}x = 4\left(x^3 + x\right) \,\mathrm{d}x \\[11pt]
        & \int \left(x^3 + x\right)\sqrt[4]{x^4 + 2x^2 - 5} \,\mathrm{d}x \begin{aligned}[t]
            & = \dfrac{1}{4}\int 4\left(x^3 + x\right)\sqrt[4]{x^4 + 2x^2 - 5} \,\mathrm{d}x \\[11pt]
            & = \dfrac{1}{4}\int \sqrt[4]{u} \,\mathrm{d}u \\[11pt]
...
\begin{tcolorbox}[example]
    \textbf{Ex 2.2.4: } $\int \dfrac{3x^2 + 4x - 5}{\left(x^3 + 2x^2 - 5x + 2\right)^3} \,\mathrm{d}x$
\end{tcolorbox}
\begin{tcolorbox}[solution]
    \textbf{Sol 2.2.4: } \begin{align*}
        & x^3 + 2x^2 - 5x + 2 \text{ is the inner function.} \\[11pt]
        & \curvedarrow u = x^3 + 2x^2 - 5x + 2 \\[5.5pt]
        & \curvedarrow \dd u = \left(3x^2 + 4x - 5\right) \,\mathrm{d}x \\[11pt]
        & \int \dfrac{3x^2 + 4x - 5}{\left(x^3 + 2x^2 - 5x + 2\right)^3} \,\mathrm{d}x \begin{aligned}[t]
            & = \int \dfrac{1}{u^3} \,\mathrm{d}u \\[11pt]
...
\begin{tcolorbox}[example]
    \textbf{Ex 2.2.5: } $\int \sin (5x) \,\mathrm{d}x$
\end{tcolorbox}
\begin{tcolorbox}[solution]
    \textbf{Sol 2.2.5: } \begin{align*}
        & \curvedarrow u = 5x \\[5.5pt]
        & \curvedarrow \dd u = 5 \,\mathrm{d}x \\[11pt]
        & \int \sin (5x) \,\mathrm{d}x \begin{aligned}[t]
            & = \dfrac{1}{5}\int 5\sin (5x) \,\mathrm{d}x \\[11pt]
            & = \dfrac{1}{5}\int \sin (u) \,\mathrm{d}u \\[11pt]
...
\begin{tcolorbox}[example]
    \textbf{Ex 2.2.6: } $\int \sin^6 (x)\cos (x) \,\mathrm{d}x$
\end{tcolorbox}
\begin{tcolorbox}[solution]
    \textbf{Sol 2.2.6: }\begin{align*}
        & \curvedarrow u = \sin (x) \\[5.5pt]
        & \curvedarrow \dd u = \cos (x) \,\mathrm{d}x \\[11pt]
        & \int \sin^6 (x)\cos (x) \,\mathrm{d}x \begin{aligned}[t]
            & = \int u^6 \,\mathrm{d}u \\[11pt]
...
\begin{tcolorbox}[example]
    \textbf{Ex 2.2.7: } $\int x^5\sin \left(x^6\right) \,\mathrm{d}x$ 
\end{tcolorbox}
\begin{tcolorbox}[solution]
    \textbf{Sol 2.2.7: } \begin{align*}
        & \curvedarrow u = x^6 \\[5.5pt]
        & \curvedarrow \dd u = 6x^5 \,\mathrm{d}x \\[11pt]
        & \int x^5\sin \left(x^6\right) \,\mathrm{d}x \begin{aligned}[t]
            & = \dfrac{1}{6}\int 6x^5\sin \left(x^6\right) \,\mathrm{d}x \\[11pt]
            & = \dfrac{1}{6}\int \sin (u) \,\mathrm{d}u \\[11pt]
...
\begin{tcolorbox}[example]
    \textbf{Ex 2.2.8: } $\int \cot^3 (x)\csc^2 (x) \,\mathrm{d}x$ 
\end{tcolorbox}
\begin{tcolorbox}[solution]
    \textbf{Sol 2.2.8 } \begin{align*}
        & \curvedarrow u = \cot (x) \\[5.5pt]
        & \curvedarrow \dd u = -\csc^2 (x) \,\mathrm{d}x \\[11pt]
        & \int \cot^3 (x)\csc^2 (x) \,\mathrm{d}x \begin{aligned}[t]
            & = -\int \cot^3 (x)\left(-\csc^2 (x)\right) \,\mathrm{d}x \\[11pt]
            & = -\int u^3 \,\mathrm{d}u \\[11pt]
            & = -\dfrac{1}{4}u^4 \,\mathrm{d}u + C \\[11pt]
...
\begin{tcolorbox}[example]
    \textbf{Ex 2.2.9: } $\int \dfrac{\cos (\sqrt{x})}{\sqrt{x}} \,\mathrm{d}x$
\end{tcolorbox}
\begin{tcolorbox}[solution]
    \textbf{Ex 2.2.9: } \begin{align*}
        & \curvedarrow u = \sqrt{x} \\[5.5pt]
        & \curvedarrow \dd u = \dfrac{1}{2}x^{-\frac{1}{2}} \\[11pt]
        & \int \dfrac{\cos (\sqrt{x})}{\sqrt{x}} \,\mathrm{d}x \begin{aligned}[t]
            & = 2\int (\cos (\sqrt{x}))\left(\dfrac{1}{2}x^{-\frac{1}{2}}\right) \,\mathrm{d}x \\[11pt]
            & = 2\int \cos (u) \,\mathrm{d}u \\[11pt]
            & = 2\sin (u) + C \\[11pt]
...
\begin{tcolorbox}[example]
    \textbf{Ex 2.2.10: } $\int xe^{x^2 + 1} \,\mathrm{d}x$
\end{tcolorbox}
\begin{tcolorbox}[solution]
    \textbf{Sol 2.2.10: } \begin{align*}
        & \curvedarrow u = x^2 + 1 \\[5.5pt]
        & \curvedarrow \dd u = 2x \,\mathrm{d}x \\[11pt]
        & \int xe^{x^2 + 1} \,\mathrm{d}x \begin{aligned}[t]
            & = \dfrac{1}{2}\int (2x)e^{x^2 + 1} \,\mathrm{d}x \\[11pt]
            & = \dfrac{1}{2}\int e^u \,\mathrm{d}u \\[11pt]
...
\begin{tcolorbox}[example]
    \textbf{Ex 2.2.11: } $\int \dfrac{x}{\sqrt{1 - x^4}} \,\mathrm{d}x$
\end{tcolorbox}
\begin{tcolorbox}[solution]
    \textbf{Sol 2.2.11: } \begin{align*}
        & \curvedarrow u = x^2 \\[5.5pt]
        & \curvedarrow \dd u = 2x \,\mathrm{d}x \\[11pt]
        & \int \dfrac{x}{\sqrt{1 - x^4}} \,\mathrm{d}x \begin{aligned}[t]
            & = \dfrac{1}{2}\int (2x)\dfrac{1}{\sqrt{1 - \left(x^2\right)^2}} \,\mathrm{d}x \\[11pt]
            & = \dfrac{1}{2} \int \dfrac{1}{\sqrt{1 - u^2}} \,\mathrm{d}u \\[11pt]
...
\begin{tcolorbox}[example]
    \textbf{Ex 2.2.12: } $\int \left(xe^{x^2} + 4x^2 - 3\sin (5x)\right) \,\mathrm{d}x$
\end{tcolorbox}
\begin{tcolorbox}[solution]
    \textbf{Ex 2.2.12: } \begin{align*}
        \int \left(xe^{x^2} + 4x^2 - 3\sin (5x)\right) \,\mathrm{d}x = \int xe^{x^2} \,\mathrm{d}x + \int 4x^2 \,\mathrm{d}x - \int 3\sin (5x) \,\mathrm{d}x
    \end{align*} \vspace{-11pt} \begin{align*}
        &\curvedarrow u_1 = x^2 && \curvedarrow u_2 = 5x \\[5.5pt]
        &\curvedarrow du_1 = 2x \,\mathrm{d}x && \curvedarrow du_2 = 5 \,\mathrm{d}x
    \end{align*} \vspace{-11pt} \begin{align*}
        \int xe^{x^2} \,\mathrm{d}x + \int 4x^2 \,\mathrm{d}x - \int 3\sin (5x) \,\mathrm{d}x \begin{aligned}[t]
            & = \dfrac{1}{2}\int (2x)e^{x^2} \,\mathrm{d}x + 4\int x^2 \,\mathrm{d}x - \dfrac{3}{5}\int 5\sin(5x) \,\mathrm{d}x \\[11pt]
            & = \dfrac{1}{2}\int e^{u_1} \,\mathrm{d}u_1 + 4\int x^2 \,\mathrm{d}x - \dfrac{3}{5}\int \sin \left(u_2\right) \,\mathrm{d}u_2 \\[11pt]
...
\twoquestion{1. $\int \left(5x + 3\right)^3 \,\mathrm{d}x$}{2. $\int \left(x^3\left(x^4 + 5\right)\right)^{24} \,\mathrm{d}x$} \\[11pt]
\twoquestion{3. $\int \left(1 + x^3\right)^2 \,\mathrm{d}x$}{4. $\int (2 - x)^{\frac{2}{3}} \,\mathrm{d}x$} \\[11pt]
\twoquestion{5. $\int x\sqrt{2x^2 + 3} \,\mathrm{d}x$}{6. $\int \dfrac{1}{(5x + 2)^3} \,\mathrm{d}x$} \\[11pt]
\twoquestion{7. $\int \dfrac{x^3}{\sqrt{1 + x^4}} \,\mathrm{d}x$}{8. $\int \dfrac{x + 1}{\sqrt[3]{x^2 + 2x + 3}} \,\mathrm{d}x$} \\[11pt]
\twoquestion{9. $\int \left(x^5 - \sin (3x) + xe^{x^2}\right) \,\mathrm{d}x$}{10. $\int \left(x^2\sec^2 \left(x^3\right) + \dfrac{\ln^3 x}{x}\right) \,\mathrm{d}x$} \\[11pt]
\twoquestion{11. $\int x^4\cos \left(x^5\right) \,\mathrm{d}x$}{12. $\int \sin (7x + 1) \,\mathrm{d}x$} \\[11pt]
\twoquestion{13. $\int \sec^2 (3x - 1) \,\mathrm{d}x$}{14. $\int \dfrac{\sin (\sqrt{x})}{\sqrt{x}} \,\mathrm{d}x$} \\[11pt]
\twoquestion{15. $\int \tan^4 (x)\sec^2 (x) \,\mathrm{d}x$}{16. $\int \dfrac{\ln x}{x} \,\mathrm{d}x$} \\[11pt]
\twoquestion{17. $\int e^{6x} \,\mathrm{d}x$}{18. $\int \dfrac{\cos (2x)}{\sin^3 (2x)} \,\mathrm{d}x$} \\[11pt]
\twoquestion{19. $\int \dfrac{x\ln \left(x^2 + 1\right)}{x^2 + 1} \,\mathrm{d}x$}{20. $\int \dfrac{e^{\sqrt{x}}}{\sqrt{x}} \,\mathrm{d}x$} \\[11pt]
\twoquestion{21. $\int \sqrt{\cot (x)}\csc^2 (x) \,\mathrm{d}x$}{22. $\int \dfrac{1}{x^2}\sin \left(\dfrac{1}{x}\right)\cos \left(\dfrac{1}{x}\right) \,\mathrm{d}x$} \\[11pt]
\twoquestion{23. $\int \dfrac{x}{1 + x^4} \,\mathrm{d}x$}{24. $\int \dfrac{\cos (x)}{\sqrt{1 - \sin^2 (x)}} \,\mathrm{d}x$} \\[11pt]

\textbf{\large{2.2 Free Response Homework Set B}} \par

Perform the antidifferentiation. \par

\twoquestion{1. $\int (2x + 5)\left(x^2 + 5x + 6\right)^6 \,\mathrm{d}x$}{2. $\int 3t^2\left(t^3 + 1\right)^5 \,\mathrm{d}t$} \\[11pt]
\twoquestion{3. $\int \dfrac{10m + 15}{\sqrt[4]{m^2 + 3m + 1}} \,\mathrm{d}m$}{4. $\int \dfrac{3x^2}{\left(1 + x^3\right)^5} \,\mathrm{d}x$} \\[11pt]
\twoquestion{5. $\int (4s + 1)^5 \,\mathrm{d}s$}{6. $\int \dfrac{5t}{t^2 + 1} \,\mathrm{d}t$} \\[11pt]
\twoquestion{7. $\int \dfrac{3m^2}{m^3 + 8} \,\mathrm{d}m$}{8. $\int (181x + 1)^5 \,\mathrm{d}x$} \\[11pt]
\twoquestion{9. $\int \dfrac{v^2}{5 - v^3} \,\mathrm{d}v$}{10. $\int \left(x^7 - \cot(5x) + xe^{x^2}\right) \,\mathrm{d}x$} \\[11pt]
\twoquestion{11. $\int \dfrac{\cos (x)}{1 + \sin (x)} \,\mathrm{d}x$}{12. $\int \left(x^2\sec^2\left(4x^3\right) + 2xe^{x^2}\right) \,\mathrm{d}x$} \\[11pt]
\twoquestion{13. $\int \sec^2 (2x) \,\mathrm{d}x$}{14. $\int \dfrac{\csc^2 \left(e^{-x}\right)}{e^x} \,\mathrm{d}x$} \\[11pt]
\twoquestion{15. $\int \dfrac{\sec (\ln x)\tan (\ln x)}{3x} \,\mathrm{d}x$}{16. $\int \left(x^5 + \dfrac{7}{x^2} - e^{2x} + \sec^2 (x)\right) \,\mathrm{d}x$} \\[11pt]
\twoquestion{17. $\int e^x\csc \left(e^x\right)\cot \left(e^x\right) \,\mathrm{d}x$}{18. $\int \left(e^x - 2\right)\left(e^x - 1\right) \,\mathrm{d}x$} \\[11pt]
\twoquestion{19. $\int x^2\sin \left(x^3\right) \,\mathrm{d}x$}{20. $\int te^{5t^2 + 1} \,\mathrm{d}t$} \\[11pt]
\twoquestion{21. $\int \left(e^y + 1\right)^2 \,\mathrm{d}y$}{22. $\int x\sec^2 \left(x^2\right)\sqrt{\tan \left(x^2\right)} \,\mathrm{d}x$} \\[11pt]
\twoquestion{23. $\int \sin (3t)\cos^5 (3t) \,\mathrm{d}t$}{24. $\int x\cos \left(x^2\right)e^{\sin \left(x^2\right)} \,\mathrm{d}x$} \\[11pt]
\twoquestion{25. $\int \tan (\theta)\ln (\sec (\theta)) \, d\theta$}{26. $\int \left(e^{4y} + 2y^2 - 7\cos (3y)\right) \,\mathrm{d}y$} \\[11pt]
\twoquestion{27. $\int \dfrac{\sin (x + 4)}{\cos^7 (x + 4)} \,\mathrm{d}x$}{28. $\int \left(\dfrac{2x}{x^2 + 5} - \sec^2 (3x) + xe^{x^2} - \pi\right) \,\mathrm{d}x$} \\[11pt]
\twoquestion{29. $\int e^{2t}\sec^2 \left(e^{2t}\right) \,\mathrm{d}t$}{30. $\int \dfrac{18\ln m}{m} \,\mathrm{d}m$} \\[11pt]
...
\onequestion{33. $\int t\sec^2 \left(4t^2\right)\sqrt{\tan \left(4t^2\right)} \,\mathrm{d}t$. Verify your answer by taking the derivative.} \\[11pt]
\onequestion{34. $\int \dfrac{2y\cos \left(y^2\right)}{\sin^4 \left(y^2\right)} \,\mathrm{d}y$. Verify your answer by taking the derivative.} \\[11pt]

\textbf{\large{2.2 Multiple Choice Homework}} \par

\begin{questions}
    \question $\int \dfrac{x}{x^2 - 4} \,\mathrm{d}x = $ \\
    ...
    \question $\int \dfrac{e^{\sqrt{x}}}{2\sqrt{x}} \,\mathrm{d}x = $ \\
    ...
    \question When using the substitution $u = \sqrt{1 + x}$, an antiderivative of $\int 60x\sqrt{1 + x} \,\mathrm{d}x$ is. \\
    ...
    \question $\int \dfrac{3x^2}{\sqrt{x^3 + 3}} \,\mathrm{d}x = $ \\
    ...
    \question $\int x\left(x^2 - 1\right)^4 \,\mathrm{d}x = $ \\
    ...
    \question $\int 4x^2\sqrt{3 + x^3} \,\mathrm{d}x = $ \\
    ...
    \question $\int \left(x^3 + 2 + \dfrac{1}{x^2 + 1}\right) \,\mathrm{d}x = $ \\
    ...
    \question $\int \cos (3 - 2x) \,\mathrm{d}x = $ \\
    ...
    \question $\int \dfrac{x - 2}{x - 1} \,\mathrm{d}x = $ \\
    ...
    \question $\int \dfrac{e^{x^2} - 2x}{e^{x^2}} \,\mathrm{d}x = $ \\
    ...
    \question $\int 6\sin (x)\cos^2 (x) \,\mathrm{d}x = $ \\
    ...
    \question $\int \dfrac{4x}{1 + x^2} \,\mathrm{d}x = $ \\
    ...
    \question $\int \dfrac{x}{4 + x^2} \,\mathrm{d}x = $ \\
    ...
    \question $\int \left(2^x - 4e^{2\ln x}\right) \,\mathrm{d}x = $ \\
    ...
    \question Which of the following statements are true? \begin{align*}
        & \text{I. } \int x^4\sin \left(x^5\right) \,\mathrm{d}x = -\dfrac{1}{5}\cos \left(x^5\right) + C \\[11pt]
        & \text{II. } \int \tan (x) \,\mathrm{d}x = \sec^2 (x) + C \\[11pt]
        & \text{III. } \int \left(x^3 + x\right)\sqrt[4]{x^4 + 2x^2 - 5} \,\mathrm{d}x = \dfrac{1}{5}\left(x^4 + 2x^2 - 5\right)^{\frac{5}{4}} + C
    \end{align*}
