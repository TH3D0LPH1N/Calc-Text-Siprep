...
\begin{questions}
    ...
    \begin{oneparchoices}
        \choice $\int \left(5^x + 2e^{-x}\right) \,\mathrm{d}x = \dfrac{5^x}{\ln 5} + 2e^{-x} + C$
        \choice $\int \cot^3 (x)\csc^2 (x) \,\mathrm{d}x = \dfrac{1}{4}\cot^4 (x) + C$ \\[11pt]
        \makebox[0.035\textwidth] \choice $\int (x - 1)\sqrt{x} \,\mathrm{d}x = \dfrac{2}{3}x^{\frac{3}{2}} - \dfrac{1}{2}x^{\frac{1}{2}} + C$
        \makebox[0.15\textwidth] \choice $\int \dfrac{\sin \sqrt{x}}{\sqrt{x}} \,\mathrm{d}x = -2\cos \left(\sqrt{x}\right) + C$
    ...
    %Question 6
    \question $\int \dfrac{4y^3 - 2y^2 - 5y}{\sqrt{y}} \,\mathrm{d}y = $ \\
    ...
    \question Identify the first mistake (if any) in this process: \begin{align*}
        ...
        & \text{Step 1:} && \dfrac{1}{1 - y} \,\mathrm{d}y = x \,\mathrm{d}x \\[5.5pt]
...
\begin{questions}
    ...
    \begin{parts}
        \part $\int \left(2x^5 + 2^x - \dfrac{17}{\sqrt[5]{x^2}} - \dfrac{1}{5x^2}\right) \,\mathrm{d}x$

        \vfill

        \parthline

        \part $\int e^{5x}\csc \left(e^{5x}\right) \,\mathrm{d}x$
        ...
        \part $\int \left(\cos (3x) + \cos^2 (5x) + \sin (7x)\sqrt{\cos (7x)}\right) \,\mathrm{d}x$
...
\begin{questions}
    ...
    \question Which of the following statements are \textbf{true}? \begin{align*}
        & \text{I. } \int \left(x^3 + x\right)\sqrt[4]{x^4 + 2x^2 - 5} \,\mathrm{d}x = \dfrac{1}{5}\left(x^4 - 2x^2 - 5\right)^{\frac{5}{4}} + C \\[11pt]
        & \text{II. } \int x^5\sin \left(x^6\right) \,\mathrm{d}x = -\dfrac{1}{6}\cos \left(x^6\right) + C \\[11pt]
    ...
    % Question 4
    \question $\int x\sqrt{1 - x^2} \,\mathrm{d}x = $ \\
    ...
    %Question 6
    \question For $\int \sec^2 (x)\tan^2 (x) \,\mathrm{d}x$, the correct u-substitution is \\
...
\begin{questions}
    ...
    \begin{parts}
        \part $\int \dfrac{t^3 - 4t - 3}{5t^{\frac{2}{3}}} \,\mathrm{d}t$

        \vfill

        \parthline

        \part $\int \dfrac{x^2}{\left(x^3 - 1\right)^{\frac{3}{2}}} \,\mathrm{d}x$
        ...
        \part $\int x\sqrt{-3x^2 + 17} \,\mathrm{d}x$
