...
\begin{tcolorbox}[solution]
    \textbf{Sol 2.1.11: } \begin{align*}
        & y \begin{aligned}[t]
            & = \int (\sec (x)(\sec (x)\tan (x))) \, dx \\[11pt]
            & = \int \left(\sec^2 (x)\right) \, dx + \int (\sec (x)\tan (x)) \, dx \\[11pt]
            & = \tan (x) + \sec (x) + C  
        \end{aligned} \\[11pt]
        & 0 = \tan (0) + \sec (0) + C \\[11pt]
...
\twoquestion{1. $\int \left(6x^2 - 2x + 3\right) \, dx$}{2. $\int \left(x^3 + 3x^2 - 2x + 4\right) \, dx$} \\[11pt]
\twoquestion{3. $\int \dfrac{2}{\sqrt[3]{x}} \, dx$}{4. $\int \left(8x^4 - 4x^3 + 9x^2 + 2x + 1\right) \, dx$} \\[11pt]
\twoquestion{5. $\int x^3\left(4x^2 + 5\right) \, dx$}{6. $\int (4x - 1)(3x + 8) \, dx$} \\[11pt]
\twoquestion{7. $\int \left(\sqrt{x} - \dfrac{6}{\sqrt{x}}\right) \, dx$}{8. $\int \dfrac{x^2 + \sqrt{x} + 3}{x} \, dx$} \\[11pt]
\twoquestion{9. $\int (x + 1)^3 \, dx$}{10. $\int (4x - 3)^2 \, dx$} \\[11pt]
\twoquestion{11. $\int \left(\sqrt{x} + 3\sqrt{3} - \dfrac{6}{\sqrt{x}}\right) \, dx$}{12. $\int \dfrac{4x^3 + \sqrt{x} + 3}{x^2} \, dx$} \\[11pt]
\twoquestion{13. $\int \left(x^2 + 5x + 6\right) \, dx$}{14. $\int \dfrac{x^2 - 4x + 7}{x} \, dx$} \\[11pt]
\twoquestion{15. $\int \dfrac{x^5 - 7x^3 + 2x - 9}{2x} \, dx$}{16. $\int \dfrac{x^3 + 3x^2 + 3x + 1}{x + 1} \, dx$} \\[11pt]
\twoquestion{17. $\int \left(y^2 + 5\right)^2 \, dy$}{18. $\int \left(4t^2 + 1\right)\left(3t^3 + 7\right) \, dt$} \\[11pt]
