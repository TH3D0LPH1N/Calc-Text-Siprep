\textbf{\large{2.5 Powers of Trig Functions: Sine and Cosine}} \par
...
\fbox{\fbox{\begin{minipage}{0.96\textwidth}
    \vspace{11pt}
    \begin{center}
        $\hfill \sin^2 (\theta) + \cos^2 (\theta) = 1 \hfill \tan^2 (\theta) + 1 = \sec^2 (\theta) \hfill \cot^2 (\theta) + 1 = \csc^2 (\theta) \hfill$ \\
    \end{center}
    \vspace{11pt}
\end{minipage}}}
