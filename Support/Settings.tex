...
\newcommand{\diff}{\dfrac{\mathrm{d}}{\mathrm{d}x}}
\newcommand{\tdiff}{\dfrac{\mathrm{d}}{\mathrm{d}t}}
\newcommand{\deriv}[1][]{%
    \ifthenelse{\equal{#1}{}}%
        {\dfrac{\mathrm{d}y}{\mathrm{d}x}}
        {\dfrac{\mathrm{d}^{#1}y}{\mathrm{d}x^{#1}}}
}
...
\newcommand{\longchoice}[1]{%
    \choice \parbox[t]{\dimexpr\linewidth-\labelwidth-\itemindent-\labelsep}{%
        \raggedright #1%
    }%
}
...
% Custom Colors - to be added soon
...
\usetikzlibrary{shapes.geometric, arrows.meta, positioning, decorations.pathreplacing, backgrounds, intersections}
