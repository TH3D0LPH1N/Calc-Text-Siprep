...
For 13 -- 16, find the absolute maximum and minimum values of $f$ on the given intervals. \par
...
\twoquestion{17. $f(x) = e^{-x} - e^{-2x} \bargap x \in [0, \, 1]$}{$f(y) = \sin \left(\dfrac{y}{3}\right) + \dfrac{2y}{9} \bargap y \in [-10, \, 15]$} \\[11pt]
