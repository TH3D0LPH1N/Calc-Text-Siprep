    ...
    \begin{center}
        \begin{tikzpicture}
            ...
            \begin{axis}[
                ...
                ylabel = {$y$},
                xmin=-5.5, xmax=5.5,
                ymin=-5.5, ymax=5.5, % Set y-axis from -5 to 5
                xtick={-5,-4,...,5}, % Shorthand for spacing by 1
                ytick={-5,-4,...,5}, % Shorthand for spacing by 1
                grid = both,
                ...
                % \addplot [
                %     domain=-2.23:2.23, % Only plot the part that fits (sqrt(5) approx 2.23)
                %     samples=100, 
                %     color=blue,
                %     thick,
                % ]
    ...
    \begin{center}
        ...
        \begin{tikzpicture}
            ...
            \begin{axis}[
                ...
                \addplot [
                    domain=-4:4, % Only plot the part that fits (sqrt(5) approx 2.23)
                    samples=100, 
                    color=blue,
                    very thick,
                ]
    ...
    \begin{center}
        \begin{tikzpicture}
            ...
            \begin{axis}[
                ...
                xtick={-3,-2,...,3}, % Shorthand for spacing by 1
    ...
    \begin{center}
        \fbox{\begin{tikzpicture}
            ...
            \begin{axis}[
                ...
                \addplot [
                    domain=-3.5:2.23, % Only plot the part that fits (sqrt(5) approx 2.23)
                    samples=100, 
                    color=blue,
                    very thick,
                ]
    ...
    \begin{center}
        \begin{tikzpicture}
            ...
            \begin{axis}[
                ...
                xmin=-3.5, xmax=10.5,
                ymin=-5.5, ymax=5.5, % Set y-axis from -5 to 5
                xtick={-3,-2,...,10}, % Shorthand for spacing by 1
                ytick={-5,-4,...,5}, % Shorthand for spacing by 1
                grid = both,
                grid style = {dashed, gray!70},
                width=10cm,
    ...
    \begin{center}
        \begin{tikzpicture}
            ...
            \begin{axis}[
                ...
                ylabel = {$y$},
                xmin=-7, xmax=13,
                ymin=-7, ymax=7, % Set y-axis from -5 to 5
                xtick={-6,-4,...,12}, % Shorthand for spacing by 1
                ytick={-6,-4,...,6}, % Shorthand for spacing by 1
                grid = both,
                grid style = {dashed, gray!70},
                width=10cm,
                height=10cm,
...
\begin{questions}
    ...
    $\begin{tikzpicture}[baseline=(current bounding box.center)]
            ...
            \node at (5,0.5) {$+$};
            \node at (-0.5, 0.5) {$f'$};
    \end{tikzpicture} \hfill \begin{tikzpicture}[baseline=(current bounding box.center)]
        \draw[<->, thick] (0,0) -- (6,0);
    ...
    \begin{oneparchoices}
        \choice \vspace{11pt} \begin{tikzpicture}[scale = 0.7]
            % Generated with Google Gemini
            ...
            \begin{axis}[
                ...
                ylabel = {$y$},
                xmin=-0.25, xmax=5.25,
                ymin=-3.25, ymax=3.25, % Set y-axis from -5 to 5
                xtick={0,1,...,5}, % Shorthand for spacing by 1
                ytick={-3,-2,...,3}, % Shorthand for spacing by 1
        ...
        \makebox[0.035\textwidth] \choice \vspace{11pt} \begin{tikzpicture}[scale = 0.7]
            % Generated with Google Gemini
    ...
    \begin{oneparchoices}
        \choice \vspace{11pt} \begin{tikzpicture}[scale = 0.7]
            ...
            \begin{axis}[
                ...
                ylabel = {$y$},
                xmin=-0.25, xmax=5.25,
                ymin=-0.25, ymax=4.25, % Set y-axis from -5 to 5
                xtick={0,1,...,5}, % Shorthand for spacing by 1
                ytick={0,1,...,4}, % Shorthand for spacing by 1
                minor xtick={0,0.5,...,5.5},  % Minor ticks at 0.5 (unlabeled)
