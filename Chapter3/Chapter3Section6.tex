...
\begin{tcolorbox}[example]
    ...
    \begin{enumerate}[label=\hspace{11pt}(\alph*), align=left, leftmargin=*, labelsep=0.25em]
        ...
        \item Use a left Riemann sum with sub-intervals indicated by the table to approximate $\int_6^{16} C(t) \,\mathrm{d}t \forcespace$. Using correct units, explain the meaning of this value in the context of the problem. \\
...
\begin{tcolorbox}[solution]
    ...
    a) Since this question asks for a total amount, we know that we must find the integral of the rate of potatoes that are being delivered to the factory. Therefore, we have \begin{align*}
        \text{Total tons} = \int_6^{12} P(t) \,\mathrm{d}t = \int_6^{12} 9 - \dfrac{9\sin(x - 2)}{x - 2} = \boxed{54.899 \text{ tons of potatoes}}
    \end{align*}
    b) Using our setup for approximation with left-hand rectangles, we have \begin{align*}
        \int_6^{16} C(t) \,\mathrm{d}t \approx (9 - 6) \cdot 7.9 + (13 - 9) \cdot 6.5 + (14 - 13) \cdot 3.9 + (16 - 14) \cdot 3.1 = 59.8
    \end{align*}
...
\begin{tcolorbox}[example]
    ...
    \begin{enumerate}[label=\hspace{11pt}(\alph*), align=left, leftmargin=*, labelsep=0.25em]
        ...
        \item Use a trapezoidal sum with subintervals indicated by the table to approximate $\int_0^{20} V(t) \,\mathrm{d}t$. Using correct units, explain the meaning of this value in the context of the problem. \\
        \item Find the value of $\int_0^{20} V'(t) \,\mathrm{d}t$ and explain the meaning of this value in the context of the problem.
    \end{enumerate}
\end{tcolorbox}
\begin{tcolorbox}[solution]
    \textbf{Sol 3.6.2: } \par
    ...
    b) Using our setup for the trapezoidal rule, we get \begin{align*}
        \int_0^{20} V(t) \,\mathrm{d}t &\approx \dfrac{83 + 68}{2} \cdot (4 - 0) + \dfrac{68 + 83}{2} \cdot (6 - 4) + \dfrac{83 + 48}{2} \cdot (10 - 6) \\[5.5pt]
    ...
    c) For this problem, since we see an integral and a derivative, we know that we must utilize the Fundamental Theorem of Calculus. Therefore, we have \begin{align*}
        \int_0^{20} V'(t) \,\mathrm{d}t = V(20) - V(0) = 38 - 83 = -45 \si{gal \per min}
    \end{align*}
...
\begin{enumerate}[label=\hspace{11pt}(\alph*), align=left, leftmargin=*, labelsep=0.25em]
    \item Estimate $V'(7)$. Show the work that leads to your answer. Indicate the units. 
    \item Find $\int_8^{40} V'(t) \,\mathrm{d}t$. 
    \item Use a trapezoidal sum with sub-intervals indicated by the table to approximate \\ $\int_0^{48} V(t) \,\mathrm{d}t \forcespace$. Using correct units, explain the meaning of this value in the context of the problem.
    \item Using correct units, explain the meaning of $\dfrac{1}{48}\int_0^{48} V(t) \,\mathrm{d}t$ in the context of the problem.
...
\begin{enumerate}[label=\hspace{11pt}(\alph*), align=left, leftmargin=*, labelsep=0.25em]
    ...
    \item Use right-hand rectangles with sub-intervals indicated by the table to approximate $\int_0^4 H(t) \,\mathrm{d}t \forcespace$. Using correct units, explain the meaning of this value in the context of the problem. 
    \item Using correct units, explain the meaning of $\dfrac{1}{4}\int_0^4 H(t) \,\mathrm{d}t$ in the context of the problem.
\end{enumerate} \vspace{11pt}
...
\begin{enumerate}[label=\hspace{11pt}(\alph*), align=left, leftmargin=*, labelsep=0.25em]
    ...
    \item Use right-hand Riemann rectangles to approximate $\int_0^{90} R(t) \,\mathrm{d}t$ and indicate units of measure. Explain the meaning of $\int_0^{90} R(t) \,\mathrm{d}t$ in terms of the fuel consumption. 
    \item Use left-hand rectangles to find $\dfrac{1}{70}\int_{20}^{90} R(t) \,\mathrm{d}t$. Using the correct units, explain the meaning of $\dfrac{1}{70}\int_{20}^{90} R(t) \,\mathrm{d}t$ in terms of the fuel consumption.
\end{enumerate} \vspace{11pt}
...
\begin{enumerate}[label=\hspace{11pt}(\alph*), align=left, leftmargin=*, labelsep=0.25em]
    ...
    \item Use midpoint Riemann rectangles to approximate $\int_1^7 G(t) \,\mathrm{d}t$. Using the correct units, explain the meaning of $\dfrac{1}{7}\int_1^7 G(t) \,\mathrm{d}t$ in terms of the patient's glucose levels.
...
\end{align*} 
\begin{enumerate}[label=\hspace{11pt}(\alph*), align=left, leftmargin=*, labelsep=0.25em]
    \item Find $\int_0^{21} A'(t) \,\mathrm{d}t$. Show the work that leads to your answer. Explain the meaning of $\int_0^{21} A'(t) \,\mathrm{d}t$ in terms of A1c scores. 
    \item Use a right-hand Riemann approximation to approximate $\int_0^{21} A(t) \,\mathrm{d}t$. Using the correct units, explain the meaning of $\dfrac{1}{21}\int_0^{21} A(t) \,\mathrm{d}t$ in terms of the patient's A1c score.
    \item A model of $A(t)$ is $B(t) = -0.305x + 10.571 + 0.1\sin(\pi x)$. Find $\dfrac{1}{21}\int_0^{21} B(t) \,\mathrm{d}t$.
\end{enumerate} \vspace{11pt}
...
\end{align*}
\begin{enumerate}[label=\hspace{11pt}(\alph*), align=left, leftmargin=*, labelsep=0.25em]
    \item Use a right-hand Riemann approximation to approximate $\int_0^{12} P(t) \,\mathrm{d}t$. Indicate the units.
    \item A model of $P(t)$ is $k(t) = 660 - 489\cos \left(\dfrac{\pi}{6}t\right)$ is a model of $P(t)$. Find $\int_0^{12} k(t) \,\mathrm{d}t$.
...
\begin{enumerate}[label=\hspace{11pt}(\alph*), align=left, leftmargin=*, labelsep=0.25em]
    ...
    \item Use right-hand Riemann rectangles to approximate $\int_0^{12} C_e(t) \,\mathrm{d}t$. Indicate the units. 
    \item Use midpoint Riemann rectangles to approximate $\int_0^{12} C_g(t) \,\mathrm{d}t$. Indicate the units.
    \item Using the correct units, explain the meaning of $\dfrac{1}{12}\int_0^{12} C_g(t) \,\mathrm{d}t$.
\end{enumerate} \vspace{11pt}
...
\begin{enumerate}[label=\hspace{11pt}(\alph*), align=left, leftmargin=*, labelsep=0.25em]
    ...
    \item Use a right Riemann sum with sub-intervals indicated by the table to approximate $\int_0^8 W(t) \,\mathrm{d}t \forcespace$. Using correct units, explain the meaning of this value in the context of the problem.
