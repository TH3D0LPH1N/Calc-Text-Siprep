...
\begin{center}  
    \fbox{\fbox{\begin{minipage}{0.96 \textwidth}
        ...
        \begin{center}
            ...
            \\[11pt]
            $\deriv[2] = \text{``d squared y, d - x squared''} \rightarrow \dfrac{\dd ^3y}{\dd x^3}, \; \dfrac{\dd ^4y}{\dd x^4} \dots \dfrac{\dd ^ny}{\dd x^n}$ \\[11pt]
            $\dfrac{\dd ^2}{\dd x^2} = \text{``d squared, d - x squared''} \rightarrow \dfrac{\dd ^3}{\dd x^3}, \; \dfrac{\dd ^4}{\dd x^4} \dots \dfrac{\dd ^n}{\dd x^n}$ \\[11pt]
...
\begin{tcolorbox}[example]
    \textbf{Ex 1.4.1: } $\dfrac{\dd ^2}{\dd x^2} \left[x^4 - 7x^3 - 3x^2 + 2x - 5\right]$
\end{tcolorbox}
\begin{tcolorbox}[solution]
    \textbf{Sol 1.4.1: } \begin{align*}
        \dfrac{\dd ^2}{\dd x^2} \left[x^4 - 7x^3 - 3x^2 + 2x - 5\right] &= \diff \left[\diff \left[x^4 - 7x^3 - 3x^2 + 2x - 5\right]\right] \\[11pt]
...
\begin{tcolorbox}[example]
    \textbf{Ex 1.4.2: } Find $\dfrac{\dd ^3y}{\dd x^3}$ if $y = \sin (3x)$.
\end{tcolorbox} 
\begin{tcolorbox}[solution]
    \textbf{Sol 1.4.2: } \begin{align*}
        ...
        & \dfrac{\dd ^3y}{\dd x^3} = -9\cos (3x) \cdot 3 = \boxed{-27\cos (3x)}
    \end{align*}
\end{tcolorbox}
...
\begin{tcolorbox}[example]
    \textbf{Ex 1.4.3: } $y = e^{3x^2}$, find $\dfrac{\dd ^y}{\dd x^2}$. 
\end{tcolorbox}
\begin{tcolorbox}[solution]
