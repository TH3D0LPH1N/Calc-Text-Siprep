...
\twoquestion{23. $y = \sec (3x)$, find $\dfrac{d^2y}{dx^2}$}{24. $y = xe^{2x}$, find $\dfrac{d^2y}{dx^2}$} \\[11pt]
...
\twoquestion{29. $y = \dfrac{x^2 - 3}{x^2 - 10}$, find $\dfrac{d^2y}{dx^2}$}{30. $y = \dfrac{3x + 3}{x^3 + 1}$, find $\dfrac{d^2y}{dx^2}$} \\[11pt]
