...
\begin{center}
    \includegraphics[width=0.49\textwidth]{\graphicsdir Chapter 1 Graphics/1.6-Graphic1.png}
    \hfill
    \includegraphics[width=0.49\textwidth]{\graphicsdir Chapter 1 Graphics/1.6-Graphic2.png}
\end{center}
...
\includegraphics[width=\textwidth]{\graphicsdir Chapter 1 Graphics/1.6-Graphic3.png}
...
\onequestion{18. Use Euler's Method with 2 equal step sizes to find an approximation for $f(0)$, given that $f(-1) = 2$ and $\deriv = 6x^2 - x^2y$.} \\[11pt]
...
\onequestion{20. Use Euler's Method with 3 equal step sizes to find an approximation for $f(2.6)$, given that $f(2) = -2$ and $\deriv = 2x + y$.} \\[11pt]
...
\begin{questions}
    ...
    \begin{center}
        \includegraphics[width = 0.6\textwidth]{\graphicsdir Chapter 1 Graphics/1.6-Graphic4.png}
    \end{center} 
