...
\begin{center}
    \fbox{\fbox{\begin{minipage}{0.96\textwidth}
        \vspace{11pt}
        \begin{align*}
            & \text{The Product Rule: } f'(x) = U \cdot \dfrac{\dd V}{\dd x} + V \cdot \dfrac{\dd U}{\dd x} \\[11pt]
            & \text{The Quotient Rule: } f'(x) = \dfrac{V \cdot \dfrac{\dd U}{\dd x} - U \cdot \dfrac{\dd V}{\dd x}}{V^2} \\[11pt]
        \end{align*}
    \end{minipage}}}
\end{center}
...
\begin{tcolorbox}[solution]
    \textbf{Sol 1.3.3: } \begin{align*}
        & U = x^2, \; \dfrac{\dd U}{\dd x} = 2x \\[11pt]
        & V = e^{-\frac{x}{2}}, \; \dfrac{\dd V}{\dd x} = e^{-\frac{x}{2}} \cdot \left(-\dfrac{1}{2}\right) = -\dfrac{1}{2}e^{-\frac{x}{2}} \\[11pt]
        & f'(x) \begin{aligned}[t]
...
\begin{tcolorbox}[solution]
    \textbf{Sol 1.3.4: } \begin{align*}
        & U = x, \; \dfrac{\dd U}{\dd x} = 1 \\[11pt]
        & V = \sqrt{1 - x^2} = \left(1 - x^2\right)^\frac{1}{2}, \; \dfrac{\dd V}{\dd x} = \dfrac{1}{2}\left(1 - x^2\right)^{-\frac{1}{2}} \cdot (-2x) = -\dfrac{x}{\sqrt{1 - x^2}} \\[11pt]
...
\begin{tcolorbox}[solution]
    \textbf{Sol 1.3.5: } \begin{align*}
        & U = (2x - 3)^8, \; \dfrac{\dd U}{\dd x} = 8(2x - 3)^7 \cdot 2 = 16(2x - 3)^7 \\[11pt]
        & V = \left(3x^2 - 1\right)^7, \; \dfrac{\dd V}{\dd x} = 7\left(3x^2 - 1\right)^6 \cdot 6x  = 42x\left(3x^2 - 1\right)^6\\[11pt]
...
\begin{tcolorbox}[solution]
    \textbf{Sol 1.3.7: } \begin{align*}
        & U = 6x, \; \dfrac{\dd U}{\dd x} = 6 \\[11pt]
        & V = x^2 + 4, \; \dfrac{\dd V}{\dd x} = 2x \\[11pt]
...
\begin{tcolorbox}[solution]
    \textbf{Sol 1.3.8: } \begin{align*}
        & U = x^2 + 2x - 3, \; \dfrac{\dd U}{\dd x} = 2x + 2 \\[11pt]
        & V = x - 4, \; \dfrac{\dd V}{\dd x} = 1 \\[11pt]
...
\begin{tcolorbox}[solution]
    \textbf{Sol 1.3.9: } Notice that this problem becomes much easier if we simplify before applying the Quotient Rule. \begin{align*}
        ...
        & U = x - 1, \; \dfrac{\dd U}{\dd x} = 1 \\[11pt]
        & V = 2x + 1, \; \dfrac{\dd V}{\dd x} = 2 \\[11pt]
...
\begin{tcolorbox}[solution]
    \textbf{Sol 1.3.10: } \begin{align*}
        & U = \cot (3x), \; \dfrac{\dd U}{\dd x} = -\csc^2 (3x) \cdot 3 = -3\csc^2 (3x)\\[11pt]
        & V = x^2 + 1, \; \dfrac{\dd V}{\dd x} = 2x \\[11pt]
...
\begin{tcolorbox}[solution]
    \textbf{Sol 1.3.11: } \begin{align*}
        & U = 4x, \; \dfrac{\dd U}{\dd x} = 4 \\[11pt]
        & V = \sqrt{x^2 + 4} = \left(x^2 + 4\right)^\frac{1}{2}, \; \dfrac{\dd V}{\dd x} = \dfrac{1}{2}\left(x^2 + 4\right)^{-\frac{1}{2}} \cdot 2x = \dfrac{2x}{2\sqrt{x^2 + 4}} \\[11pt]
...
\begin{tcolorbox}[solution]
    ...
    The slope is the derivative at the given x-value: \begin{align*}
        & U = x, \; \dfrac{\dd U}{\dd x} = 1 \\[11pt]
        & V = \sqrt{x^2 + 9} = \left(x^2 + 9\right)^\frac{1}{2}, \; \dfrac{\dd V}{\dd x} = \dfrac{1}{2}\left(x^2 + 9\right)^{-\frac{1}{2}} \cdot 2x = \dfrac{2x}{2\sqrt{x^2 + 9}} \\[11pt]
...
\twoquestion{11. $y = \dfrac{\sec^{-1} (x)}{x}$}{12. $y = \dfrac{\sec (x)}{x^3}$} \\[11pt]
...
\twoquestion{31. $h(t) = \left(\dfrac{1 + t^2}{1 - t^2}\right)^{17}$, find $h'(t)$}{32. $y = \dfrac{\tan (x)}{\cos (x) - 3}$, find $\deriv$} \\[11pt]
...
\twoquestion{19. $\diff \left[\dfrac{x^5 - 12x^3 - 19x}{3x^3}\right]$}{20. $\diff \left[8\cos (4x + 2)\sin (4x + 2)\right]$} \\[11pt]
...
\twoquestion{25. $y = \ln \left(u^2 + 1\right) - u\cot^{-1} (u)$, find $\dfrac{\dd y}{\dd u}$}{26. $y = \cos^{-1} \left(\dfrac{x - 1}{x + 1}\right)$} \\[11pt]
