...
\begin{tcolorbox}[example]
    \textbf{Ex 1.5.7: } Consider the curve given by $x^2 + 4xy + y^2 = -12$. \\
    \begin{enumerate}[label=\hspace{11pt}(\alph*), align=left, leftmargin=*, labelsep=0.25em]
        \item Show that $\deriv = -\dfrac{x + 2y}{2x + y}$ \\
        \item Find the point(s) where the equation of the tangent line(s) is/are horizontal. \\
