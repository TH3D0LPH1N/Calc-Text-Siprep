...
\begin{center}  
    \fbox{\fbox{\begin{minipage}{0.96 \textwidth}
        \begin{align*}
            ...
            & \text{Related Rates Problems:} && \text{Apply } \tdiff \\
        \end{align*}
    \end{minipage}}}
\end{center}
...
\begin{tcolorbox}[example]
    \textbf{Ex 1.8.1: } The volume of a cylindrical cola can is $32\pi \si{in^3}$. The height of the can is changing at $\dfrac{1}{4} \si{in \per sec} \forcespace$. If the radius changes at the same time so as to maintain the volume, how fast is the radius shrinking when the can is $4$ inches tall? 
\end{tcolorbox} 
\begin{tcolorbox}[solution]
    \textbf{Sol 1.8.1: } \begin{align*}
        & V = \pi r^2h = 32\pi \\[11pt]
        & h = \dfrac{32}{r^2} \\[11pt]
        & \tdiff\left[h = \dfrac{32}{r^2}\right] \\[11pt]
        & \dfrac{\dd h}{\dd t} = -\dfrac{64}{r^2}\left(\dfrac{\dd r}{\dd t}\right)
    \end{align*}
    Now that we have a method to find what we are looking for, $\dfrac{\dd r}{\dd t}$, let's substitute in the values that we are given in the problem. \begin{align*}
        & h = 4 \rightarrow \dfrac{32}{r^2} = 4 \rightarrow r^2 = 8 \\[11pt]
        & \dfrac{1}{4} = -\dfrac{64}{8}\left(\dfrac{\dd r}{\dd t}\right) \\[11pt]
        & \dfrac{\dd r}{\dd t} = \boxed{-\dfrac{1}{32} \si{in \per sec}}
    \end{align*}
\end{tcolorbox}
...
\begin{tcolorbox}[example]
    \textbf{Ex 1.8.2: } A $13$-foot ladder is leaning against a wall. The bottom of the ladder slides away from the wall at $4 \si{ft \per sec}$. How fast is the top of the ladder moving down the wall when the ladder is $5$ feet from the wall? \\[11pt]
...
\end{tcolorbox}
\begin{tcolorbox}[solution]
    \textbf{Sol 1.8.2: } As can be seen in the visual, the height of the top of the ladder and the distance the bottom of the ladder is from the wall is related through the Pythagorean theorem. Both are variables, because the ladder is moving. \begin{align*}
        x^2 + y^2 = 13^2
    \end{align*}
    We are given the information that the bottom of the ladder slides away from the wall at $4 \si{ft \per sec}$. Therefore, we can say that our $\dfrac{\dd x}{\dd t} \forcespace = 4$. To find $\dfrac{\dd y}{\dd t}$, we differentiate $x^2 + y^2 = 13^2$ to get \begin{align*}
        2x\dfrac{\dd x}{\dd t} + 2y\dfrac{\dd y}{\dd t} = 0
    \end{align*}
    Although this may seem like a complex four equation variable, we already know $x$ and $\dfrac{\dd x}{\dd t} \forcespace$. We also can determine that $y = 12$ by the Pythagorean theorem. So, \begin{align*}
        & 2x\dfrac{\dd x}{\dd t} + 2y\dfrac{\dd y}{\dd t} = 0 \\[11pt]
        & 2(5)(4) + 2(12)\dfrac{\dd y}{\dd t} = 0 \\[11pt]
        & \dfrac{\dd y}{\dd t} = \boxed{-\dfrac{5}{3} \si{ft \per sec}}
    \end{align*}
    It should make sense that $\dfrac{\dd y}{\dd t}$ is negative because the top of the ladder is sliding down.
\end{tcolorbox}
...
\begin{tcolorbox}[example]
    \textbf{Ex 1.8.3: } A tank shaped like an inverted cone $8$ feet in height and with a base diameter of $8$ feet is filling at a rate of $10 \si{ft^3 \per min}$. How fast is the height changing when the water is $6$ feet deep? \\[11pt]
...
\end{tcolorbox}
\begin{tcolorbox}[solution]
    \textbf{Sol 1.8.3: } The units on the rate of change tell us that this is a change in volume, or $\dfrac{\dd V}{\dd t}$. Therefore, we use the equation \begin{align*}
        V = \dfrac{1}{3}\pi r^2h
    \end{align*}
    But, there are too many variables in this equation to differentiate as it stands. Since the rate of the change of the height---$\dfrac{\dd h}{\dd t} \forcespace$---is what we are looking for, we can eliminate $r$ from the equation. By similar triangles, we have \begin{align*}
    ...
    Substitution gives us a volume equation in terms of only height. \begin{align*}
        ...
        & V = \dfrac{\pi}{12}h^3
    \end{align*}
    Differentiate and plug in our given values to solve for $\dfrac{\dd h}{\dd t}$. \begin{align*}
        & V = \dfrac{\pi}{12}h^3 \\[11pt]
        & \dfrac{\dd V}{\dd t} = \dfrac{\pi}{4}h^2\dfrac{\dd h}{\dd t} \\[11pt]
        & 10 = \dfrac{\pi}{4}(6)^2\dfrac{\dd h}{\dd t} \\[11pt]
        & \dfrac{\dd h}{\dd t} = \boxed{\dfrac{10}{9\pi} \si{ft \per min}}
    \end{align*}
\end{tcolorbox} \vspace{11pt}

\begin{tcolorbox}[example]
    \textbf{Ex 1.8.4: } Two cars approach an intersection, one traveling south at $20$ miles per hour and the other traveling west at $30$ miles per hour. How fast is the direct distance between them decreasing when the westbound car is $0.6$ miles and the southbound car is $0.8$ miles away from the intersection? \\[11pt]
...
\end{tcolorbox}
\begin{tcolorbox}[solution]
    \textbf{Sol 1.8.4: } As we can see in the picture, the distance between the two cars are related by the Pythagorean theorem. \begin{align*}
        x^2 + y^2 = r^2
    \end{align*}
    We know several pieces of information. The southbound car is moving at $20$ miles per hour; i.e. $\dfrac{\dd y}{\dd t} = -20$. By similar logic, we can deduce each of the following: \begin{align*}
        & \dfrac{\dd y}{\dd t} = -20 && \dfrac{\dd x}{\dd t} = -30 \\[11pt]
        & y = 0.8 && x = 0.6
    \end{align*}
    And, by the Pythagorean Theorem, $r = 1$. Now we take the derivative of the Pythagorean theorem to get \begin{align*}
        2x\dfrac{\dd x}{\dd t} + 2y\dfrac{\dd y}{\dd t} = 2r\dfrac{\dd r}{\dd t}
    \end{align*}
    This is essentially an equation in six variables. But, we know five of those variables, so let's substitute and solve. \begin{align*}
        & 2(0.8)(-30) + (2)(0.6)(-20) = 2(1.0)\dfrac{\dd r}{\dd t} \\[11pt]
        & \dfrac{\dd r}{\dd t} = \boxed{-36 \si{mph}}
    \end{align*}
    It should make sense that $\dfrac{\dd r}{\dd t} \forcespace$ is negative since the two cars are approaching one another. The units also make sense: since $r$ is in miles and $h$ is in hours, the final units should be miles per hour.
\end{tcolorbox}
