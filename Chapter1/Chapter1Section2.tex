...
\twoquestion{7. $\dfrac{d}{d\theta} \left[e^{\csc (\theta)} + \ln \left(\cot \left(\theta^2\right)\right) - \sec (\theta) \right]$}{8. $\diff \left[\ln \left(\sec^3 \left(x^3 + 5\ln x + 7\right)\right)\right]$} \\[11pt]
