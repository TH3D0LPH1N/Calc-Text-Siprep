...
\begin{center}  
    \fbox{\fbox{\begin{minipage}{0.96 \textwidth}
        ...
        \begin{center}
            ...
            \\[11pt]
            $\hfill \dfrac{dy}{dx} = \text{``d - y - d - ''} \hfill f'(x) = \text{``f prime of x''} \hfill y' = \text{``y prime''} \hfill$ \\[11pt] 
...
\begin{tcolorbox}[example]
    \textbf{Ex 1.1.4: } $y = \sqrt{x^3} + \dfrac{4}{\sqrt{x}} - \sqrt[4]{x^3} + e^4$; find $\dfrac{dy}{dx}$. 
\end{tcolorbox}
\begin{tcolorbox}[solution]
...
\twoquestion{13. $\diff \left[x^4 - 14\sqrt[7]{x^9}\right] + 8^x - \dfrac{1}{\sqrt[3]{x^7}} + \dfrac{1}{8x}$}{14. $\diff \left[(x - 1)\sqrt{x}\right]$} \\[11pt]
\twoquestion{15. $\dfrac{d}{dz} \left[\left(z^2 - 4\right)\sqrt{z^3}\right]$}{16. $\diff \left[\left(x^2 - 4x + 3\right)\sqrt{x^5}\right]$} \\[11pt]
\twoquestion{17. $\dfrac{d}{dt} \left[\left(4t^2 + 1\right)\left(3t^3 + 7\right)\right]$}{18. $\diff \left[\left(x^3 + 4x - \pi\right)^{-7}\right]$} \\[11pt]
\twoquestion{19. $\diff \left[\sqrt{3x^2 - 4x + 9}\right]$}{20. $\diff \left[\sqrt[7]{x^3 - 2x}\right]$} \\[11pt]
\twoquestion{21. $\dfrac{d}{dy} \left[\dfrac{4y^3 - 2y^2 - 5y}{\sqrt y}\right]$}{22. $\dfrac{d}{dv} \left[\dfrac{v^2 - 4v + 7} {2\sqrt v}\right]$} \\[11pt]
\twoquestion{23. $\dfrac{d}{dw}\left[\dfrac{7w^2 - 4w + 1}{5w^3}\right]$}{24. $\dfrac{d}{dw}\left[\dfrac{5w^2 - 3w - 4}{7w^2}\right]$} \\[11pt]
...
\twoquestion{29. $g(2) = 3, \; g'(2) = -4, \; f(x) = e^{g(x)}$, find $f'(2)$}{30. $y = e^{\sqrt x}$, find $\dfrac{dy}{dx}$} \\[11pt]
